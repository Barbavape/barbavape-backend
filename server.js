...
// Route de diagnostic — teste la connexion Hiboutik directement
app.get("/api/test-hiboutik", async (req, res) => {
  try {
    const url = `${HIBOUTIK_BASE}/customers/`;
    const headers = getHeaders();
    console.log("Test URL:", url);
    console.log("User:", API_USER ? API_USER.substring(0, 5) + "..." : "VIDE");
    console.log("Key:", API_KEY ? API_KEY.substring(0, 5) + "..." : "VIDE");
